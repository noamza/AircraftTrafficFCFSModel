...
public class SectorTree {
	...
	/*
	public void test(){
		java.util.TreeSet<Integer> testt = new java.util.TreeSet<Integer>();
		for(int i = 2; i < 11 ; i++) testt.add(i);
		//testt.remove(5);
		System.out.println("tests node ordering \n");
		System.out.println("testt.ceiling (3): " + testt.ceiling(3));
		System.out.println("testt.floor   (3): " + testt.floor(3));
		System.out.println("testt.higher  (3): " + testt.higher(3));
		System.out.println("testt.lower   (3): " + testt.lower(3));
		
		System.out.println("FlightIntervalNode");		
		TreeSet<FlightIntervalNode> test = new TreeSet<FlightIntervalNode>();
		test.add(new FlightIntervalNode(1, 0));
		test.add(new FlightIntervalNode(2, 0));
		test.add(new FlightIntervalNode(3, 0));
		test.add(new FlightIntervalNode(4, 0));
		
		io.print("test.ceiling  (3): "); test.ceiling(new FlightIntervalNode(3)).print();
		io.print("test.floor    (3): "); test.floor(new FlightIntervalNode(3)).print();
		io.print("test.higher   (3): "); test.higher(new FlightIntervalNode(3)).print();
		io.print("test.lower    (3): "); test.lower(new FlightIntervalNode(3)).print();
		io.print("test.floor    (3+1): "); test.floor(new FlightIntervalNode(3+1)).print();
		
		
		System.out.println("AvailableWindowNode");
		TreeSet<AvailableWindowNode> testw = new TreeSet<AvailableWindowNode>();
		testw.add(new AvailableWindowNode(1, 0));
		testw.add(new AvailableWindowNode(2, 0));
		testw.add(new AvailableWindowNode(3, 0));
		testw.add(new AvailableWindowNode(4, 0));
		
		io.print("testw.ceiling  (3): "); testw.ceiling(new AvailableWindowNode(3)).print();
		io.print("testw.floor    (3): "); testw.floor(new AvailableWindowNode(3)).print();
		io.print("testw.higher   (3): "); testw.higher(new AvailableWindowNode(3)).print();
		io.print("testw.lower    (3): "); testw.lower(new AvailableWindowNode(3)).print();
		
		//Iterator<FlightIntervalNode> it = sectorTraffic.tailSet(new FlightIntervalNode(3));
		io.println("it = testt.tailSet(3,false).iterator();");
		Iterator<Integer> it = testt.tailSet(3,false).iterator();
		while(it.hasNext()){
			int cu = it.next();
			io.println("current " + cu);
		}
		
		io.println("it = testt.tailSet(3).iterator();");
		it = testt.tailSet(3).iterator();
		while(it.hasNext()){
			int cu = it.next();
			io.println("current " + cu);
		}
		...
		int n = testt.floor(1);
		//System.out.println("testt.floor   (1): " + testt.floor(1));
	...
	public void testCapacities(){
		Iterator<FlightIntervalNode> it = sectorTraffic.iterator();
		while(it.hasNext()){
			if(it.next().capacity > maxCapacity){
				throw new java.lang.Error("it.next().capacity > maxCapacity");
			}
		}
	}
	
	public void testWindows(){
		io.println("addIntervalToBlock(3, 5);");
		addIntervalToBlock(3, 5);
		printWindows();
		io.println("addIntervalToBlock(8, 10);");
		addIntervalToBlock(8, 10);
		printWindows();
		io.println("addIntervalToBlock(4, 6);");
		addIntervalToBlock(4, 6);
		printWindows();
		io.println("addIntervalToBlock(5, 6);");
		addIntervalToBlock(5, 6);
		printWindows();
		io.println("addIntervalToBlock(9, 11);");
		addIntervalToBlock(9, 11);
		printWindows();
		io.println("addIntervalToBlock(12, 14);");
		addIntervalToBlock(12, 14);
		printWindows();
		io.println("addIntervalToBlock(4, 9);");
		addIntervalToBlock(4, 9);
		printWindows();
		io.println("addIntervalToBlock(16, 17);");
		addIntervalToBlock(16, 17);
		printWindows();
		io.println("addIntervalToBlock(18, 20);");
		addIntervalToBlock(18, 20);
		printWindows();
		io.println("addIntervalToBlock(1, 80);");
		addIntervalToBlock(1, 80);
		printWindows();
	}//*/
